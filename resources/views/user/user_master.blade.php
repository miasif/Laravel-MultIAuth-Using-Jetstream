                ...
                <ul class="header_menu">
                    ...
                    <li><a data-toggle="dropdown" href="#"><i class="far fa-user"></i></a>
                            ...
                            <ul>
                                ...
                                <li><a href="{{route('user_profile')}}"><span><i class="fas fa-user"></i></span> User Profile</a></li>
                                <li><a href="{{route('user_password_change')}} "><span><i class="fas fa-cogs"></i></span>  Password Change</a></li>
                                <li>

                                    <a href="{{route('user_logout')}}"><span><i class="fas fa-unlock-alt"></i></span> Logout</a></li>
                            </ul>
                        </div>
                    </li>
                    <li>
